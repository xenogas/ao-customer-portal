...
namespace Customer_Portal.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		//NOTE: Will adapt this to include the current email address / User ID in the login field
		//		this will help make things a bit smoother for the end user
		[AllowAnonymous]
		...
		//TODO: Remove External Login features
		//[HttpPost]
		//[AllowAnonymous]
		//[ValidateAntiForgeryToken]
